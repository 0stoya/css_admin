  ...
  return (
    <>
      <FlatImportPanel
        ...
        description="Build or reorganize large parent/child company structures using company references rather than Magento IDs."
        ...
        help="Columns: company_reference, parent_reference. Leave parent_reference blank to make a company a root. Preview rejects unknown or ambiguous references, duplicate rows, self-parenting and cycles. Only companies visible to this admin can be linked."
      />
      <FlatImportPanel
